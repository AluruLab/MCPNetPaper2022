...
grep -P "^Computed,MAX |^Computing," *_full_*_eval5.log > train_test_aupr_violin.txt

# # for MI, DPI1, DPI2, DPI3:   merge compute and aupr lines.
echo "percent,iterations,method,partition,aupr,combo,aupr_time" > train_test_aupr_violin.csv
